...
export default function WorkspaceSidebar({
  ...
  return (
    <div className={`bg-gray-50 border-r border-gray-200 flex flex-col transition-all duration-300 ${isCollapsed ? 'w-12' : 'w-64'}`}>
      {!isCollapsed && (
        <>
          {/* Workspace Header */}
      ...
      <button
        ...
        className="p-3 border-t border-gray-200 hover:bg-gray-100 transition-colors flex items-center justify-center"
